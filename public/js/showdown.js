		...
		(a.Converter = function (e) {
			...
			function t(e, t) {
				if (((t = t || null), a.helper.isString(e))) {
					if (
						((e = a.helper.stdExtName(e)), (t = e), a.extensions[e])
					)
						return (
							console.warn(
								"DEPRECATION WARNING: " +
				...
				for (var i = 0; i < e.length; ++i) {
					...
					if (e[i].hasOwnProperty("listeners"))
						for (var l in e[i].listeners)
							e[i].listeners.hasOwnProperty(l) &&
								n(l, e[i].listeners[l]);
				}
			}
			function n(e, r) {
						...
						preList: (function (e) {
							for (
								...
								if (
									...
									"code" ===
										r[n].firstChild.tagName.toLowerCase()
								) {
									var s = r[n].firstChild.innerHTML.trim(),
										o =
											r[n].firstChild.getAttribute(
												"data-language"
											) || "";
									if ("" === o)
										for (
			...
			var n = function (e, n, s, o, i, l, c) {
				if (
					...
					if (
						...
						return e;
					(o = t.gUrls[s]),
						a.helper.isUndefined(t.gTitles[s]) ||
							(c = t.gTitles[s]);
				}
				var u =
					'<a href="' +
	...
	a.subParser("autoLinks", function (e, r, t) {
		...
		a.subParser("emoji", function (e, r, t) {
			...
			return (
				(e = (e = t.converter._dispatch(
					...
					return a.helper.emojis.hasOwnProperty(r)
						? a.helper.emojis[r]
						: e;
				})),
			...
			for (var o = 0; o < n.length; ++o)
				for (
					...
					var d = a.helper.splitAtIndex(e, i),
						p = a.helper.replaceRecursiveRegExp(
							d[1],
							s,
							c,
							u,
			...
			return (
				(e = a.helper.replaceRecursiveRegExp(
					...
					function (e, n, s, o) {
						...
						return (
							"\n\n¨G" +
							(t.ghCodeBlocks.push({ text: e, codeblock: i }) -
								1) +
							"G\n\n"
						);
					},
				...
				return (
					...
					(e = e.replace(s, function (e, n, s, i, l, c, u) {
						...
						return (
							...
							n || d.search(/\n{2,}/) > -1
								? ((d = a.subParser("githubCodeBlocks")(
										d,
										r,
										t
								  )),
								  (d = a.subParser("blockGamut")(d, r, t)))
								: ((d = (d = a.subParser("lists")(
										d,
										r,
										t
								  )).replace(/\n$/, "")),
								  (d = (d = a.subParser("hashHTMLBlocks")(
										d,
										r,
										t
								  )).replace(/\n\n+/g, "\n\n")),
					...
					(c = (c =
						"K" === p
							...
							? a.subParser("encodeCode")(
									t.ghCodeBlocks[h].text,
									r,
									t
							  )
							: t.ghCodeBlocks[h].codeblock).replace(
						/\$/g,
						"$$$$"
					)),
						(u = u.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, c)),
		...
		a.subParser("spanGamut", function (e, r, t) {
			...
			return (
				...
				(e = a.subParser("escapeSpecialCharsWithinTagAttributes")(
					e,
					r,
					t
				)),
						...
						return (function (e) {
							return (
								r.simplifiedAutoLink &&
									(e = a.subParser("simplifiedAutoLinks")(
										e,
										r,
										t
									)),
			...
			var n = function (e, n, s, o, i, l, c) {
				return (
					...
					s.match(/^data:.+?\/.+?;base64,/)
						...
						: (t.gUrls[n] = a.subParser("encodeAmpsAndAngles")(
								s,
								r,
								t
						  )),
		...
		a.subParser("makeMarkdown.node", function (e, r, t) {
			...
			switch (e.tagName.toLowerCase()) {
				case "h1":
					t ||
						(n =
							a.subParser("makeMarkdown.header")(e, r, 1) +
							"\n\n");
					break;
				case "h2":
					t ||
						(n =
							a.subParser("makeMarkdown.header")(e, r, 2) +
							"\n\n");
					break;
				case "h3":
					t ||
						(n =
							a.subParser("makeMarkdown.header")(e, r, 3) +
							"\n\n");
					break;
				case "h4":
					t ||
						(n =
							a.subParser("makeMarkdown.header")(e, r, 4) +
							"\n\n");
					break;
				case "h5":
					t ||
						(n =
							a.subParser("makeMarkdown.header")(e, r, 5) +
							"\n\n");
					break;
				case "h6":
					t ||
						(n =
							a.subParser("makeMarkdown.header")(e, r, 6) +
							"\n\n");
					break;
				case "p":
					t ||
						(n =
							a.subParser("makeMarkdown.paragraph")(e, r) +
							"\n\n");
					break;
				case "blockquote":
					t ||
						(n =
							a.subParser("makeMarkdown.blockquote")(e, r) +
							"\n\n");
					break;
				case "hr":
				...
				case "ol":
					t ||
						(n =
							a.subParser("makeMarkdown.list")(e, r, "ol") +
							"\n\n");
					break;
				case "ul":
					t ||
						(n =
							a.subParser("makeMarkdown.list")(e, r, "ul") +
							"\n\n");
					break;
				case "precode":
					t ||
						(n =
							a.subParser("makeMarkdown.codeBlock")(e, r) +
							"\n\n");
					break;
				case "pre":
